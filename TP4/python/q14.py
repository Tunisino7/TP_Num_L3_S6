# -*- coding: utf-8 -*-
"""
TP4 - Question 14 : Double puits asymétrique

Refaire Q12 avec r3=0 au lieu de 0.5 pour briser la symétrie.
"""
...
def main():
    """
    Programme principal - Question 14
    """
    # Paramètres
    L = 20.0
    n = 1000
    ...
    print("\n=== Analyse ===")
    print("Premiers niveaux :")
    print(f"  E_0 = {w[0]:.10f}")
    print(f"  E_1 = {w[1]:.10f}")
    print(f"  ΔE = {w[1] - w[0]:.10e}")
    ...
    ax1.set_title(f'Double puits asymétrique (a={a}, r3={r3})', fontsize=13, fontweight='bold')
    ax1.legend(fontsize=11)
    ax1.grid(True, alpha=0.3)
    ax1.set_xlim(-5, 5)
    ax1.set_ylim(-1.2, 0.5)
    
    # Fonctions d'onde des deux premiers états
    ax2 = axes[1]
    colors = ['blue', 'red']
    for p in range(2):
        psi_p = psi_norm[:, p]
    ...
    ax2.set_title('États fondamentaux dans le double puits asymétrique', 
    ...
    output_path = os.path.join(output_dir, f'q14_double_puits_asym_a{int(a)}.pdf')
    ...
    print("\n=== Commentaire ===")
    print("• La symétrie est brisée : le puits gauche est plus large que le droit.")
    print("• Les fonctions d'onde ne sont plus symétriques/antisymétriques.")
    print("• ψ_0 : localisée principalement dans le puits gauche (plus large)")
    print("• ψ_1 : localisée principalement dans le puits droit")
    print("• Les niveaux ne sont plus en doublets quasi-dégénérés.")
    print("• Levée de dégénérescence par brisure de symétrie.")
    print("• Chaque puits impose sa propre structure de niveaux.")
